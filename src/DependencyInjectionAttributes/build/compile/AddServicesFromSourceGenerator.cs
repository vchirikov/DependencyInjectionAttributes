...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    static partial class AddServicesFromSourceGenerator
    {
        ...
        /// <summary>
        /// Adds the services that matches to <paramref name="fullNameExpression"/> to the collection,
        /// </summary>
        /// <remarks>
        /// Note that NO runtime reflection is performed when using this method. A compile-time source
        /// generator will emit the relevant registration methods for all matching types (in the current
        ...
        /// <summary> Adds discovered scoped services to the collection </summary>
        static partial void AddScopedServices(IServiceCollection services);

        /// <summary> Adds discovered singleton services to the collection </summary>
        static partial void AddSingletonServices(IServiceCollection services);

        /// <summary> Adds discovered transient services to the collection </summary>
        static partial void AddTransientServices(IServiceCollection services);

        /// <summary> Adds discovered keyed scoped services to the collection </summary>
        static partial void AddKeyedScopedServices(IServiceCollection services);

        /// <summary> Adds discovered keyed singleton services to the collection </summary>
        static partial void AddKeyedSingletonServices(IServiceCollection services);

        /// <summary> Adds discovered keyed transient services to the collection </summary>
